...
CREATE TABLE TB_CONCEPT_SCHEMES (
  ID NUMBER(19) NOT NULL,
  UUID VARCHAR2(36) NOT NULL,
  CREATED_DATE_TZ VARCHAR2(50),
  CREATED_DATE TIMESTAMP,
...
CREATE TABLE TB_FACETS (
  ID NUMBER(19) NOT NULL,
  IS_SEQUENCE_FT NUMBER(1,0),
  INTERVAL_FT FLOAT(126),
  START_VALUE_FT FLOAT(126),
  END_VALUE_FT FLOAT(126),
  TIME_INTERVAL_FT VARCHAR2(14),
  START_TIME_FT VARCHAR2(255),
  END_TIME_FT VARCHAR2(255),
  MIN_LENGTH_FT NUMBER(10),
  MAX_LENGTH_FT NUMBER(10),
  MIN_VALUE_FT FLOAT(126),
  MAX_VALUE_FT FLOAT(126),
  DECIMALS_FT NUMBER(10),
  PATTERN_FT VARCHAR2(255),
  XHTML_EFT VARCHAR2(255),
  IS_MULTI_LINGUAL NUMBER(1,0),
  UUID VARCHAR2(36) NOT NULL,
  VERSION NUMBER(19) NOT NULL,
...
ALTER TABLE TB_CONCEPTS ADD CONSTRAINT PK_TB_CONCEPTS
	PRIMARY KEY (ID)
;
...
ALTER TABLE TB_CONCEPT_SCHEMES ADD CONSTRAINT PK_TB_CONCEPT_SCHEMES
	PRIMARY KEY (ID)
;
...
ALTER TABLE TB_CONCEPTS
    ADD CONSTRAINT UQ_TB_CONCEPTS UNIQUE (UUID)
;




ALTER TABLE TB_CONCEPT_SCHEMES
    ADD CONSTRAINT UQ_TB_CONCEPT_SCHEMES UNIQUE (UUID)
;
...
ALTER TABLE TB_CONCEPTS ADD CONSTRAINT FK_TB_CONCEPTS_ITEM_FK
	FOREIGN KEY (ITEM_FK) REFERENCES TB_ANNOTABLE_ARTEFACTS (ID)
;
...
ALTER TABLE TB_CONCEPT_SCHEMES ADD CONSTRAINT FK_TB_CONCEPT_SCHEMES_ITEM_S72
	FOREIGN KEY (ITEM_SCHEME_FK) REFERENCES TB_ANNOTABLE_ARTEFACTS (ID)
;
...
-- Index
CREATE INDEX IX_TB_ANNOTABLE_ARTEFACTS_DT96
    ON TB_ANNOTABLE_ARTEFACTS (DTYPE ASC)
;
