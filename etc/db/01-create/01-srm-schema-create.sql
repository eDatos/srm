...
CREATE TABLE TB_M_ORGANISATION_SCHEMES (
  PRODUCTION_VALIDATION_DATE_TZ VARCHAR2(50),
  PRODUCTION_VALIDATION_DATE TIMESTAMP,
  PRODUCTION_VALIDATION_USER VARCHAR2(255),
  DIFFUSION_VALIDATION_DATE_TZ VARCHAR2(50),
  ...
  EXT_PUBLICATION_FAILED_DATE TIMESTAMP,
  PROC_STATUS VARCHAR2(40) NOT NULL,
  TB_ORGANISATION_SCHEMES NUMBER(19) NOT NULL

);


CREATE TABLE TB_M_AGENCY_SCHEMES (
  TB_M_ORGANISATION_SCHEMES NUMBER(19) NOT NULL

);


CREATE TABLE TB_M_DATA_CONSUMER_SCHEMES (
  TB_M_ORGANISATION_SCHEMES NUMBER(19) NOT NULL

);


CREATE TABLE TB_M_DATA_PROVIDER_SCHEMES (
  TB_M_ORGANISATION_SCHEMES NUMBER(19) NOT NULL

);


CREATE TABLE TB_M_ORGANISATION_UNIT_SCHEMES (
  TB_ORGANISATION_SCHEMES NUMBER(19) NOT NULL
...
;
ALTER TABLE TB_M_ORGANISATION_SCHEMES ADD CONSTRAINT FK_TB_M_ORGANISATION_SCHEMES45
	FOREIGN KEY (TB_ORGANISATION_SCHEMES) REFERENCES TB_ITEM_SCHEMES (ID)
;
ALTER TABLE TB_M_AGENCY_SCHEMES ADD CONSTRAINT FK_TB_M_AGENCY_SCHEMES_TB_M_84
	FOREIGN KEY (TB_M_ORGANISATION_SCHEMES) REFERENCES TB_ITEM_SCHEMES (ID)
;
ALTER TABLE TB_M_DATA_CONSUMER_SCHEMES ADD CONSTRAINT FK_TB_M_DATA_CONSUMER_SCHEME40
	FOREIGN KEY (TB_M_ORGANISATION_SCHEMES) REFERENCES TB_ITEM_SCHEMES (ID)
;
ALTER TABLE TB_M_DATA_PROVIDER_SCHEMES ADD CONSTRAINT FK_TB_M_DATA_PROVIDER_SCHEME95
	FOREIGN KEY (TB_M_ORGANISATION_SCHEMES) REFERENCES TB_ITEM_SCHEMES (ID)
;
ALTER TABLE TB_M_ORGANISATION_UNIT_SCHEMES ADD CONSTRAINT FK_TB_M_ORGANISATION_UNIT_SC00
	FOREIGN KEY (TB_ORGANISATION_SCHEMES) REFERENCES TB_ITEM_SCHEMES (ID)
;
