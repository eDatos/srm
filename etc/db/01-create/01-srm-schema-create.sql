...
CREATE TABLE TB_M_CONCEPTS_RELATIONS (
  ID NUMBER(19) NOT NULL,
  CONCEPT_1_FK NUMBER(19) NOT NULL,
  CONCEPT_2_FK NUMBER(19) NOT NULL
);
...
ALTER TABLE TB_M_CONCEPTS_RELATIONS ADD CONSTRAINT PK_TB_M_CONCEPTS_RELATIONS
	PRIMARY KEY (ID)
;
...
ALTER TABLE TB_M_CONCEPTS_RELATIONS
	ADD CONSTRAINT UQ_TB_M_CONCEPTS_RELATIONS UNIQUE (ID)
;
...
ALTER TABLE TB_M_CONCEPTS_RELATIONS ADD CONSTRAINT FK_TB_M_CONCEPTS_RELATIONS_C93
	FOREIGN KEY (CONCEPT_1_FK) REFERENCES TB_ITEMS (ID)
;
ALTER TABLE TB_M_CONCEPTS_RELATIONS ADD CONSTRAINT FK_TB_M_CONCEPTS_RELATIONS_C02
	FOREIGN KEY (CONCEPT_2_FK) REFERENCES TB_ITEMS (ID)
;
