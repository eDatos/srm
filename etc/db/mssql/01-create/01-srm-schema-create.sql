...
CREATE TABLE TB_M_CODELISTS_VERSIONS (
  ...
  DEFAULT_ORDER_VISUALISATION_FK BIGINT,
  PRODUCTION_VALIDATION_DATE_TZ VARCHAR(50),
  PRODUCTION_VALIDATION_DATE DATETIME,
  PRODUCTION_VALIDATION_USER VARCHAR(255),
  DIFFUSION_VALIDATION_DATE_TZ VARCHAR(50),
...
;
ALTER TABLE TB_M_CODELISTS_VERSIONS ADD CONSTRAINT FK_TB_M_CODELISTS_VERSIONS_DEFAULT_ORDER_VISUALISATION_FK
	FOREIGN KEY (DEFAULT_ORDER_VISUALISATION_FK) REFERENCES TB_M_CODELIST_ORDER_VISUAL (ID)
;

  
ALTER TABLE TB_M_CODELIST_ORDER_VISUAL ADD CONSTRAINT FK_TB_M_CODELIST_ORDER_VISUAL_NAMEABLE_ARTEFACT_FK
	FOREIGN KEY (NAMEABLE_ARTEFACT_FK) REFERENCES TB_ANNOTABLE_ARTEFACTS (ID)
;
