...
ALTER TABLE TB_M_DIM_VIS_INFO ADD CONSTRAINT FK_TB_M_DIM_VIS_INFO_DIM_COMPONENT_FK
	FOREIGN KEY (DIM_COMPONENT_FK) REFERENCES TB_ANNOTABLE_ARTEFACTS (ID)
;
ALTER TABLE TB_M_DIM_VIS_INFO ADD CONSTRAINT FK_TB_M_DIM_VIS_INFO_DISPLAT_ORDER_FK
	FOREIGN KEY (DISPLAT_ORDER_FK) REFERENCES TB_M_CODELIST_ORDER_VIS (ID)
;
