...
ALTER TABLE TB_M_VARIABLE_ELEMENTS DROP CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_NAMEABLE_ARTEFACT_FK;
...
ALTER TABLE TB_M_CODELISTS_VERSIONS DROP CONSTRAINT FK_TB_M_CODELISTS_VERSIONS_DEFAULT_ORDER_VISUALISATION_FK;

  
ALTER TABLE TB_M_CODELIST_ORDER_VISUAL DROP CONSTRAINT FK_TB_M_CODELIST_ORDER_VISUAL_NAMEABLE_ARTEFACT_FK;
ALTER TABLE TB_M_CODELIST_ORDER_VISUAL DROP CONSTRAINT FK_TB_M_CODELIST_ORDER_VISUAL_CODELIST_FK;

  
ALTER TABLE TB_M_CODE_ORDER_VISUAL DROP CONSTRAINT FK_TB_M_CODE_ORDER_VISUAL_CODE_FK;
ALTER TABLE TB_M_CODE_ORDER_VISUAL DROP CONSTRAINT FK_TB_M_CODE_ORDER_VISUAL_CODELIST_VISUALISATION_FK;
...
ALTER TABLE TB_M_MEASURE_DIM_PRECISIONS DROP CONSTRAINT FK_TB_M_MEASURE_DIM_PRECISIONS_M_CODE_FK;
...
DROP TABLE TB_M_CODE_ORDER_VISUAL;

DROP TABLE TB_M_CODELIST_ORDER_VISUAL;
