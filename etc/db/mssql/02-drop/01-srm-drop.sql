...
ALTER TABLE TB_M_CODELIST_FAMILIES DROP CONSTRAINT FK_TB_M_CODELIST_FAMILIES_NAME_FK;
...
ALTER TABLE TB_M_VARIABLE_FAMILIES DROP CONSTRAINT FK_TB_M_VARIABLE_FAMILIES_NAME_FK;

  
ALTER TABLE TB_M_VARIABLES DROP CONSTRAINT FK_TB_M_VARIABLES_NAME_FK;
ALTER TABLE TB_M_VARIABLES DROP CONSTRAINT FK_TB_M_VARIABLES_SHORT_NAME_FK;
ALTER TABLE TB_M_VARIABLES DROP CONSTRAINT FK_TB_M_VARIABLES_VARIABLE_FAMILY_FK;
