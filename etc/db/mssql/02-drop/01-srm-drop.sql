...
ALTER TABLE TB_M_VARIABLE_ELEMENTS DROP CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_COMMENT_FK;
ALTER TABLE TB_M_VARIABLE_ELEMENTS DROP CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_REPLACED_BY_VAR_ELEMENT_FK;
ALTER TABLE TB_M_VARIABLE_ELEMENTS DROP CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_GEOGRAPHICAL_GRANULARITY_FK;
...
ALTER TABLE TB_M_QUANTITIES DROP CONSTRAINT FK_TB_M_QUANTITIES_UNIT_CODE_FK;
ALTER TABLE TB_M_QUANTITIES DROP CONSTRAINT FK_TB_M_QUANTITIES_NUMERATOR_FK;
ALTER TABLE TB_M_QUANTITIES DROP CONSTRAINT FK_TB_M_QUANTITIES_DENOMINATOR_FK;
ALTER TABLE TB_M_QUANTITIES DROP CONSTRAINT FK_TB_M_QUANTITIES_PERCENTAGE_OF_FK;
ALTER TABLE TB_M_QUANTITIES DROP CONSTRAINT FK_TB_M_QUANTITIES_BASE_LOCATION_FK;
ALTER TABLE TB_M_QUANTITIES DROP CONSTRAINT FK_TB_M_QUANTITIES_BASE_QUANTITY_FK;
...
ALTER TABLE TB_M_CONCEPTS DROP CONSTRAINT FK_TB_M_CONCEPTS_QUANTITY_FK;
...
ALTER TABLE TB_M_DIM_VIS_INFO DROP CONSTRAINT FK_TB_M_DIM_VIS_INFO_DIM_COMPONENT_FK;
ALTER TABLE TB_M_DIM_VIS_INFO DROP CONSTRAINT FK_TB_M_DIM_VIS_INFO_DISPLAY_ORDER_FK;
ALTER TABLE TB_M_DIM_VIS_INFO DROP CONSTRAINT FK_TB_M_DIM_VIS_INFO_HIERARCHY_LEVELS_OPEN_FK;
ALTER TABLE TB_M_DIM_VIS_INFO DROP CONSTRAINT FK_TB_M_DIM_VIS_INFO_DSD_VERSION_FK;
