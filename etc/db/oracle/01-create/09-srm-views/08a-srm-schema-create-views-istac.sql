...
SELECT i.ID as ID_CODIGO, ai.CODE as CODIGO, c.VARIABLE_ELEMENT_FK as ID_ITEM, aParent.CODE as CODIGO_COMPUESTO,
CAST(aisv.VALID_FROM AS DATE) as FECHA_INICIO, CAST(aisv.VALID_TO AS DATE) as FECHA_FIN, isv.ID as ID_CODIF
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_ANNOTABLE_ARTEFACTS ai ON ai.ID = i.NAMEABLE_ARTEFACT_FK
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
...
LEFT OUTER JOIN TB_ITEMS_BASE iParent ON i.PARENT_FK = iParent.ID
LEFT OUTER JOIN TB_ANNOTABLE_ARTEFACTS aParent ON aParent.ID = iParent.NAMEABLE_ARTEFACT_FK
WHERE cv.ACCESS_TYPE in ('PUBLIC', 'RESTRICTED') AND cv.PROC_STATUS = 'EXTERNALLY_PUBLISHED'
ORDER BY ID_CODIF;
...
SELECT i.ID as ID_ITEM, lsName.LABEL as NOMBRE_LARGO,  NVL(lsShortNameVe.LABEL, lsShortName.LABEL) as NOMBRE_CORTO, ve.VARIABLE_FK as ID_CONCEPTO
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ANNOTABLE_ARTEFACTS ai ON ai.ID = i.NAMEABLE_ARTEFACT_FK
...
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER1 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER2 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER3 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER4 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER5 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER6 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER7 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER8 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER9 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER10 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER11 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER12 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER13 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER14 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER15 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER16 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER17 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER18 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER19 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
...
UNION
(
SELECT o.ID as ID_ORDEN, i.ID as ID_CODIGO, c.ORDER20 as ORDEN
FROM TB_M_CODES c
INNER JOIN TB_ITEMS_BASE i ON c.TB_CODES = i.ID
INNER JOIN TB_M_CODELISTS_VERSIONS cv ON cv.TB_CODELISTS_VERSIONS = i.ITEM_SCHEME_VERSION_FK
INNER JOIN TB_ITEM_SCHEMES_VERSIONS isv ON isv.ID = cv.TB_CODELISTS_VERSIONS
