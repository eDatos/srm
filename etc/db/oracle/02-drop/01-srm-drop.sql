...
DROP TABLE TB_M_DIM_VIS_INFO CASCADE CONSTRAINTS PURGE;
...
DROP TABLE TB_M_QUANTITIES CASCADE CONSTRAINTS PURGE;
...
DROP TABLE TB_M_CODELIST_OPENNESS_VIS CASCADE CONSTRAINTS PURGE;

DROP TABLE TB_M_CODELISTS_VERSIONS CASCADE CONSTRAINTS PURGE;

DROP TABLE TB_M_CODELIST_ORDER_VIS CASCADE CONSTRAINTS PURGE;
...
DROP TABLE TB_MISC_VALUES CASCADE CONSTRAINTS PURGE;
