...
-- DATASOURCE: ORACLE
insert into TB_CONFIGURATIONS (CONF_KEY,CONF_VALUE) values ('metamac.srm.db.url','jdbc:oracle:thin:@FILL_ME_WITH_HOST:FILL_ME_WITH_PORT:XE');
...
insert into TB_CONFIGURATIONS (CONF_KEY,CONF_VALUE) values ('metamac.srm.db.driver_name','oracle.jdbc.OracleDriver');
insert into TB_CONFIGURATIONS (CONF_KEY,CONF_VALUE) values ('metamac.srm.db.dialect','org.siemac.metamac.hibernate.dialect.Oracle10gDialectMetamac');
