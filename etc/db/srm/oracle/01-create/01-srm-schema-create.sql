...
CREATE TABLE TB_M_CAT_SCHEMES_VERSIONS (
  ...
  STREAM_MESSAGE_STATUS VARCHAR2(255 CHAR) NOT NULL
);
...
CREATE TABLE TB_M_VARIABLES (
  ...
  VARIABLE_TYPE VARCHAR2(255 CHAR)
);
...
ALTER TABLE TB_M_VARIABLE_ELEMENTS ADD CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_SH38
	FOREIGN KEY (SHORT_NAME_FK) REFERENCES TB_INTERNATIONAL_STRINGS (ID)
;
ALTER TABLE TB_M_VARIABLE_ELEMENTS ADD CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_CO19
...
;
ALTER TABLE TB_M_VARIABLE_ELEMENTS ADD CONSTRAINT FK_TB_M_VARIABLE_ELEMENTS_GE77
...
;
ALTER TABLE TB_M_QUANTITIES ADD CONSTRAINT FK_TB_M_QUANTITIES_BASE_LOCA48
