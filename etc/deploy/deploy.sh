...
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-srm-web/target/structural-resources-internal-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/structural-resources-internal.war
scp -o ProxyCommand="ssh -W %h:%p deploy@estadisticas.arte-consultores.com" metamac-srm-external-web/target/structural-resources-*.war deploy@estadisticas.arte.internal:$TRANSFER_PATH/structural-resources.war
