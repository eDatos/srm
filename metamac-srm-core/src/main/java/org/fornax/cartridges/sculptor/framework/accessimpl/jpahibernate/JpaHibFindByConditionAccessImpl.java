...
//    }
    ...
    private Criterion makeCriterion(ConditionalCriteria crit) {
        ...
        if (Operator.Equal.equals(operator)) {
            ...
            return Restrictions.or(makeCriterion((ConditionalCriteria) crit.getFirstOperant()), makeCriterion((ConditionalCriteria) crit.getSecondOperant()));
            ...
            return Restrictions.and(makeCriterion((ConditionalCriteria) crit.getFirstOperant()), makeCriterion((ConditionalCriteria) crit.getSecondOperant()));
    ...
    private void getRecursiveSubCriteriaNames(ConditionalCriteria crit, Set<String> names) {
        ...
        if (crit != null
                && crit.getFirstOperant() != null
                && (crit.getOperator().equals(Operator.EqualProperty) || crit.getOperator().equals(Operator.LessThanProperty) || crit.getOperator().equals(Operator.LessThanOrEqualProperty)
                        || crit.getOperator().equals(Operator.GreatThanProperty) || crit.getOperator().equals(Operator.GreatThanOrEqualProperty))) {
