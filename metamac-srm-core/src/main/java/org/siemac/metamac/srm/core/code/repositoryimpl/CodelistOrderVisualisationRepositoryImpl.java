...
public class CodelistOrderVisualisationRepositoryImpl extends CodelistOrderVisualisationRepositoryBase {
    ...
    @Override
    public void checkCodelistOrderVisualisationTranslations(Long itemSchemeVersionId, String locale, Map<String, MetamacExceptionItem> exceptionItemsByUrn) throws MetamacException {
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT distinct(a.URN) ");
        sb.append("FROM TB_M_CODELIST_ORDER_VIS ov ");
