...
public class CodesMetamacInvocationValidator extends CodesInvocationValidator {
    ...
    public static void checkImportCodesTsv(String codelistUrn, File file, String fileName, boolean updateAlreadyExisting, Boolean canBeBackground, List<MetamacExceptionItem> exceptions)
            throws MetamacException {
        if (exceptions == null) {
            exceptions = new ArrayList<MetamacExceptionItem>();
        }
    ...
    public static void checkImportCodeOrdersTsv(String codelistUrn, File file, String fileName, Boolean canBeBackground, List<MetamacExceptionItem> exceptions) throws MetamacException {
        if (exceptions == null) {
            exceptions = new ArrayList<MetamacExceptionItem>();
        }
    ...
    public static void checkImportVariableElementsTsv(String variableUrn, File file, String fileName, Boolean updateAlreadyExisting, Boolean canBeBackground, List<MetamacExceptionItem> exceptions)
            throws MetamacException {
        if (exceptions == null) {
            exceptions = new ArrayList<MetamacExceptionItem>();
        }
