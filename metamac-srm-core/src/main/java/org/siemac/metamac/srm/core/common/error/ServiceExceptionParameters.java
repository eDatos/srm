...
public class ServiceExceptionParameters extends com.arte.statistic.sdmx.srm.core.common.error.ServiceExceptionParameters {
    ...
    public static final String CONCEPT_SCHEME_RELATED_OPERATION_TITLE                     = CONCEPT_SCHEME + ".related_operation.title";
    // TYPES
    ...
    public static final String CONCEPT_ROLE                                               = CONCEPT + ".role";
    ...
    public static final String CODELIST_OPENNESS_VISUALISATION                            = "codelist_openness_visualisation";
    public static final String CODELIST_OPENNESS_VISUALISATION_EXPANDED                   = CODELIST_OPENNESS_VISUALISATION + ".expanded";
    ...
    public static final String DATA_STRUCTURE_DEFINITION_DIMENSION_REPRESENTATION_UPDATED = DATA_STRUCTURE_DEFINITION + ".dimension.is_representation_updated";
    public static final String DATA_STRUCTURE_DEFINITION_DIMENSION_CONCEPTID_UPDATED      = DATA_STRUCTURE_DEFINITION + ".dimension.is_conceptid_updated";
