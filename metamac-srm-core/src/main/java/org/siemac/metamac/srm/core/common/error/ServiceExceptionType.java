...
public class ServiceExceptionType extends com.arte.statistic.sdmx.srm.core.common.error.ServiceExceptionType {
    ...
    public static final CommonServiceExceptionType CONCEPT_REPRESENTATION_ENUMERATED_CODELIST_VARIABLE_REQUIRED                       = create("exception.srm.concepts.concept.enumerated_representation_codelist.variable_required");
    ...
    public static final CommonServiceExceptionType CODELIST_ORDER_VISUALISATION_DELETING_NOT_SUPPORTED_CODELIST_WAS_EVER_PUBLISHED    = create("exception.srm.codelists.order_visualisation.delete_not_supported.belonged_to_codelist_was_published");
    ...
    public static final CommonServiceExceptionType CODELIST_OPENNESS_VISUALISATION_DELETING_NOT_SUPPORTED_CODELIST_WAS_EVER_PUBLISHED = create("exception.srm.codelists.openness_visualisation.delete_not_supported.belonged_to_codelist_was_published");
    ...
    public static final CommonServiceExceptionType DATA_STRUCTURE_DEFINITION_DIM_REPRESENTATION_ENUM_REQUIRED                         = create("exception.srm.dsd.validation.dimension.representation.enumerated.required");
    ...
    public static final CommonServiceExceptionType DATA_STRUCTURE_DEFINITION_ATTR_REPRESENTATION_ENUM_REQUIRED                        = create("exception.srm.dsd.validation.attribute.representation.enumerated.required");
    public static final CommonServiceExceptionType DATA_STRUCTURE_DEFINITION_ATTR_REPRESENTATION_NONENUM_REQUIRED                     = create("exception.srm.dsd.validation.attribute.representation.nonenumerated.required");
    public static final CommonServiceExceptionType DATA_STRUCTURE_DEFINITION_ATTR_RELATETO_INVALID                                    = create("exception.srm.dsd.validation.attribute.relateto.invalid");
