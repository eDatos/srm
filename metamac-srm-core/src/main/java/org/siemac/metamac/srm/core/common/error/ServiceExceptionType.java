...
public class ServiceExceptionType extends CommonServiceExceptionType {
    ...
    public static final CommonServiceExceptionType CONCEPT_SCHEME_ALREADY_EXIST_ID_LOGIC_DUPLICATED = create("exception.srm.concepts.concept_scheme.already_exist.code_duplicated");
