...
public class ServiceExceptionType extends com.arte.statistic.sdmx.srm.core.common.error.ServiceExceptionType {
    ...
    public static final CommonServiceExceptionType IMPORTATION_TSV_METADATA_UNEXPECTED_SDMX_RELATED_ARTEFACT = create("exception.srm.importation.tsv.error.metadata_unexpected_smdx_related_artefact");
