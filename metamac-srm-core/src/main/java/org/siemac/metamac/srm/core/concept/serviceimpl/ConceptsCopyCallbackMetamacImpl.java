...
public class ConceptsCopyCallbackMetamacImpl extends ConceptsCopyCallbackImpl {
    ...
    public void createItemSchemeVersionRelations(ServiceContext ctx, ItemSchemeVersion sourceItemSchemeVersion, ItemSchemeVersion targetItemSchemeVersion) throws MetamacException {
        ...
        conceptsMetamacService.versioningConceptsQuantity(ctx, source, target);
    }
    ...
    public void copyItem(Item sourceItem, ItemResult sourceItemResult, Item targetItem) {
        ...
        // Related concepts: Do not copy related concepts in this point, because they belong to same concept scheme, and new concept in new version must relate to versioned related concept
        // They will be copied in createItemSchemeVersionRelations

        // Quantity: Do not copy quantity in this point, because related concepts can belong to same concept scheme, and new concept in new version must relate to versioned concept
        // They will be copied in createItemSchemeVersionRelations
    }
