...
public class ConceptsMetamacInvocationValidator extends ConceptsInvocationValidator {
    ...
    public static void checkExportConceptsTsv(String conceptSchemeUrn, List<MetamacExceptionItem> exceptions) throws MetamacException {
        if (exceptions == null) {
            exceptions = new ArrayList<MetamacExceptionItem>();
        }
        ...
        if (SrmValidationUtils.mustValidateMetadataRequired(conceptSchemeVersion, creating)) {
            ...
            if (ConceptSchemeTypeEnum.OPERATION.equals(conceptSchemeVersion.getType())) {
                ...
                if (conceptSchemeVersion.getRelatedOperation() != null) {
                    ...
                    ValidationUtils.checkMetadataEmpty(conceptSchemeVersion.getRelatedOperation().getUrnProvider(), ServiceExceptionParameters.CONCEPT_SCHEME_RELATED_OPERATION, exceptions);
                }
