...
public class CodesDo2DtoMapperTest extends SrmBaseTest {
    ...
    public void testCodelistMetamacDoToDto() {
        CodelistVersionMetamac entity = mockCodedelistWithAllMetadata();
        entity.setReplacedByCodelist(mockCodedelistWithAllMetadata());
        entity.addReplaceToCodelist(mockCodedelistWithAllMetadata());
        entity.addReplaceToCodelist(mockCodedelistWithAllMetadata());
    ...
    private CodelistVersionMetamac mockCodedelistWithAllMetadata() {
