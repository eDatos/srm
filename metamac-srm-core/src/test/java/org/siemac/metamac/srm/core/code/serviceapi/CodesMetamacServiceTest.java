...
public class CodesMetamacServiceTest extends SrmBaseTest implements CodesMetamacServiceTestBase {
    ...
    public void testPublishInternallyCodelistCheckTranslations() throws Exception {
        ...
        try {
            ...
            {
                i++;
                MetamacExceptionItem exceptionItem = assertListContainsExceptionItemOneParameter(e, ServiceExceptionType.RESOURCE_WITH_INCORRECT_METADATA,
    ...
    public void testFindCodesByCondition() throws Exception {
        // Find all
        {
            ...
            // Validate
            assertEquals(36, codesPagedResult.getTotalRows());
            assertEquals(36, codesPagedResult.getValues().size());
            ...
            assertEquals(CODELIST_10_V1_CODE_2, codesPagedResult.getValues().get(i++).getNameableArtefact().getUrn());
    ...
    public void testUpdateVariableTypeGeographicalToNull() throws Exception {
        ...
        // Check variable elements before update
        {
            ...
            assertNotNull(variableElement.getShapeWkt());
        ...
        // Check variable elements
        {
            ...
            assertNull(variableElement.getShapeWkt());
    ...
    public void testCreateVariableElementErrorIncorrectMetadataGeographical() throws Exception {
        ...
        variableElement.setShapeWkt(null);
    ...
    public void testRetrieveVariableElementGeographicalByUrn() throws Exception {
        ...
        assertEquals("MULTIPOLYGON (((-17.91900240266335 28.856725761393726)))", variableElement.getShapeWkt());
    ...
    public void testFindVariableElementsByCondition() throws Exception {
        // Find all
        {
            ...
            assertEquals(VARIABLE_5_VARIABLE_ELEMENT_4, result.getValues().get(i++).getIdentifiableArtefact().getUrn());
        }
        // Find by urn
        {
    ...
    public void testCreateVersionFromTemporalCodelist() throws Exception {
        ...
        assertTrue(CollectionUtils.isNotEmpty(temporalCodelistVersionMetamac.getItems()));

        int expectedItemsNumber = temporalCodelistVersionMetamac.getItems().size();
        ...
        TaskInfo versioningTemporalToVersionResult = codesService.createVersionFromTemporalCodelist(getServiceContextAdministrador(), temporalCodelistVersionMetamac.getMaintainableArtefact().getUrn(),
                Boolean.TRUE, VersionTypeEnum.MAJOR);
        entityManager.clear();
        ...
        // Validate
        {
            ...
            assertTrue(CollectionUtils.isNotEmpty(codelistVersionNewVersion.getItems()));
            assertEquals(expectedItemsNumber, codelistVersionNewVersion.getItems().size());
        }
    }

    @Test
    public void testCreateVersionFromTemporalCodelistCodesNotIncluded() throws Exception {
        String urn = CODELIST_3_V1;
        ...
        // -- No temporal
        TaskInfo versioningTemporalToVersionResult = codesService.createVersionFromTemporalCodelist(getServiceContextAdministrador(), temporalCodelistVersionMetamac.getMaintainableArtefact().getUrn(),
                Boolean.FALSE, VersionTypeEnum.MAJOR);
        entityManager.clear();
        CodelistVersionMetamac codelistVersionNewVersion = codesService.retrieveCodelistByUrn(getServiceContextAdministrador(), versioningTemporalToVersionResult.getUrnResult());
        ...
        // Validate
        {
            ...
            assertTrue(CollectionUtils.isEmpty(codelistVersionNewVersion.getItems()));
        }
    }
    ...
    public void testExportCodeOrdersTsv() throws Exception {
        ...
        InputStreamReader inputStreamReader = new InputStreamReader(fileInputStream, "UTF-8");
        BufferedReader bufferedReader = new BufferedReader(inputStreamReader);
        assertEquals("code\tlabel\tlevel\tparent\tALPHABETICAL\tVISUALISATION02\tVISUALISATION03", bufferedReader.readLine());
        assertEquals("CODE01\tIsla de Tenerife\t1\t\t1\t1\t2", bufferedReader.readLine());
        assertEquals("CODE02\tNombre codelist-1-v2-code-2 Canaria, Gran\t1\t\t2\t2\t3", bufferedReader.readLine());
        assertEquals("CODE0201\tcodelist-1-v2-code-2- Isla de La Gomera\t2\tCODE02\t1\t1\t2", bufferedReader.readLine());
        assertEquals("CODE020101\tSanta Cruz de La Palma codelist-1-v2-code-2-1-1\t3\tCODE0201\t1\t1\t1", bufferedReader.readLine());
        assertEquals("CODE0202\tIsla de El Hierro\t2\tCODE02\t2\t2\t1", bufferedReader.readLine());
        assertEquals("CODE03\tFuerteventura\t1\t\t3\t3\t1", bufferedReader.readLine());
    ...
    public void testImportVariableElementsPoints() throws Exception {
        ...
        }
        {
            ...
            assertEquals("MULTIPOLYGON (((-18.91900240266335 29.856725761393726)))", variableElement.getShapeWkt());
        ...
        }
        {
            ...
            assertEquals("MULTIPOLYGON (((-19.91900240266335 30.856725761393726)))", variableElement.getShapeWkt());
