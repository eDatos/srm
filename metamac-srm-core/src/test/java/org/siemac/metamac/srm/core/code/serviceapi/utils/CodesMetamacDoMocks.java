...
public class CodesMetamacDoMocks extends CodesDoMocks {
    ...
    public static void fillVariableFamilyAutogeneratedMetadata(VariableFamily entity) {
        entity.getUuid(); // generate uuid
    ...
    public static void fillVariableAutogeneratedMetadata(Variable entity) {
        entity.getUuid(); // generate uuid
    ...
    public static void fillVariableElementAutogeneratedMetadata(VariableElement entity) {
        entity.getUuid(); // generate uuid
    ...
    public static void fillCodelistOrderVisualisationAutogeneratedMetadata(CodelistOrderVisualisation entity) {
        entity.getUuid(); // generate uuid
