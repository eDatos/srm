...
@RunWith(Suite.class)
@Suite.SuiteClasses({BaseServiceTest.class, ConceptsServiceTest.class, SrmCoreServiceFacadeTest.class, SrmCoreServiceFacadeCoreMockedTest.class, DataStructureDefinitionServiceTest.class,
        JavaSerializationTest.class, KryoTest.class})
