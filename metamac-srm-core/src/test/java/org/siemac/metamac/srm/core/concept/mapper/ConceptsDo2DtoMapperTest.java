...
public class ConceptsDo2DtoMapperTest extends SrmBaseTest {
    ...
    public void testConceptSchemeMetamacDoToDto() {
        ...
        ConceptSchemeVersionMetamac entity = ConceptsMetamacDoMocks.mockConceptScheme(organisationMetamac);
    ...
    private ConceptMetamac mockConceptWithAllMetadata() {
        OrganisationMetamac organisationMetamac = organisationMetamacRepository.findByUrn(AGENCY_ROOT_1_V1);
        ConceptMetamac entity = ConceptsMetamacDoMocks.mockConcept(new ConceptType(), null);
        fillConceptAutogeneratedMetadata(entity);
        entity.setItemSchemeVersion(ConceptsMetamacDoMocks.mockConceptScheme(organisationMetamac));
        entity.setVariable(mockVariable());
        return entity;
    }

    private Variable mockVariable() {
        Variable variable = CodesMetamacDoMocks.mockVariable();
        CodesMetamacDoMocks.fillVariableAutogeneratedMetadata(variable);
        return variable;
    }
