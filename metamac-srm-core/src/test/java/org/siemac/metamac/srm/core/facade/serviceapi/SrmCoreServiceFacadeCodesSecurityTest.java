...
public class SrmCoreServiceFacadeCodesSecurityTest extends SrmBaseTest {
    ...
    public void testCreateCodelist() throws Exception {
        srmCoreServiceFacade.createCodelist(getServiceContextJefeNormalizacion(), CodesMetamacDtoMocks.mockCodelistDto(AGENCY_ROOT_1_V1_CODE, AGENCY_ROOT_1_V1));
    }
    ...
    public void testRetrieveCodesByCodelistUrn() throws Exception {
        ...
        for (ServiceContext ctx : ctxs) {
            srmCoreServiceFacade.retrieveCodesByCodelistUrn(ctx, CODELIST_1_V1);
        }
    }
