package org.siemac.metamac.srm.core.mock;
...
public class Mocks {
    ...
    public static ExternalItemBt createConceptExternalItemBt() {
        return new ExternalItemBt(RandomStringUtils.random(50, true, true), RandomStringUtils.randomAlphabetic(10), TypeExternalArtefactsEnum.CONCEPT);
    }
    ...
    public static DataStructureDefinitionDto createDdsDTOwhitDescription() {
        ...
        name_es.setLocale("es");
        LocalisedStringDto name_en = new LocalisedStringDto();
        name_en.setLabel("DESCRIPTION EN DSD");
        name_en.setLocale("en");
    ...
    public static RelationshipDto createAttributeRelationship(SrmCoreServiceFacade srmCoreServiceFacade, Long dataStructureDefinitionId) throws MetamacException {
        ...
        DescriptorDto descriptorDto4 = srmCoreServiceFacade.saveDescriptorForDsd(getServiceContext(), dataStructureDefinitionId, Mocks.createGroupDimensionDescriptorDto());
