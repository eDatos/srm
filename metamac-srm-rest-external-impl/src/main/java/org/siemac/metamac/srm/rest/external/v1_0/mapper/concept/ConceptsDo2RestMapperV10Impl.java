...
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityAmount;
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityChangeRate;
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityFraction;
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityIndex;
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityMagnitude;
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityRate;
import org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityRatio;
...
public class ConceptsDo2RestMapperV10Impl extends ItemSchemeBaseDo2RestMapperV10Impl implements ConceptsDo2RestMapperV10 {
    ...
    public Resource toResource(ConceptSchemeVersion source) {
        ...
        toResource(source.getMaintainableArtefact(), SrmRestConstants.KIND_CONCEPT_SCHEME, toConceptSchemeSelfLink(source), target);
        return target;
    }
    ...
    public ItemResource toResource(com.arte.statistic.sdmx.srm.core.concept.domain.Concept source) {
        ...
        toResource(source, SrmRestConstants.KIND_CONCEPT, toConceptSelfLink(source), target);
        return target;
    }
    ...
    private org.siemac.metamac.rest.structural_resources.v1_0.domain.ConceptSchemeType toConceptSchemeTypeEnum(ConceptSchemeTypeEnum source) {
        if (source == null) {
            return null;
        }
        switch (source) {
            case GLOSSARY:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.ConceptSchemeType.GLOSSARY;
            case OPERATION:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.ConceptSchemeType.OPERATION;
            case ROLE:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.ConceptSchemeType.ROLE;
            case TRANSVERSAL:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.ConceptSchemeType.TRANSVERSAL;
            case MEASURE:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.ConceptSchemeType.MEASURE;
            default:
    ...
    private ItemResource toResource(ItemResult source, ConceptSchemeVersionMetamac conceptSchemeVersion) {
        ...
        ItemResource target = new ItemResource();
        toResource(source, SrmRestConstants.KIND_CONCEPT, toConceptSelfLink(source, conceptSchemeVersion), target, conceptSchemeVersion.getMaintainableArtefact().getIsImported());
        return target;
    }
    ...
    private org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityUnitSymbolPosition toQuantityUnitSymbolPosition(QuantityUnitSymbolPositionEnum source) {
        if (source == null) {
            return null;
        }
        switch (source) {
            case START:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityUnitSymbolPosition.START;
            case END:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.QuantityUnitSymbolPosition.END;
            default:
                org.siemac.metamac.rest.common.v1_0.domain.Exception exception = RestExceptionUtils.getException(RestServiceExceptionType.UNKNOWN);
                throw new RestException(exception, Status.INTERNAL_SERVER_ERROR);
        }
