...
import org.siemac.metamac.rest.structural_resources.v1_0.domain.DimensionVisualisations;
...
import org.siemac.metamac.srm.rest.external.v1_0.mapper.base.StructureBaseDo2RestMapperV10Impl;
...
public class DataStructuresDo2RestMapperV10Impl extends StructureBaseDo2RestMapperV10Impl implements DataStructuresDo2RestMapperV10 {
    ...
    private org.siemac.metamac.rest.structural_resources.v1_0.domain.AttributeUsageStatusType toAttributeUsageStatusType(UsageStatus source) {
        ...
        switch (source) {
            case CONDITIONAL:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.AttributeUsageStatusType.CONDITIONAL;
            case MANDATORY:
                return org.siemac.metamac.rest.structural_resources.v1_0.domain.AttributeUsageStatusType.MANDATORY;
            default:
                org.siemac.metamac.rest.common.v1_0.domain.Exception exception = RestExceptionUtils.getException(RestServiceExceptionType.UNKNOWN);
                throw new RestException(exception, Status.INTERNAL_SERVER_ERROR);
        }
    ...
    private void toComponentList(ComponentList source, org.siemac.metamac.rest.structural_resources.v1_0.domain.Components target, Boolean isImported) {
        if (source == null) {
            return;
        }
    ...
    private void toComponent(Component source, org.siemac.metamac.rest.structural_resources.v1_0.domain.Component target, Boolean isImported) {
        if (source == null) {
            return;
        }
