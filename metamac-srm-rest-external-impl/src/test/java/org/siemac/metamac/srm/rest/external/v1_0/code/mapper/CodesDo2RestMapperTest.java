package org.siemac.metamac.srm.rest.external.v1_0.code.mapper;
...
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesAsserts.assertEqualsResource;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockCode;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockCodeItemResult;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockCodelist;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockCodelistFamily;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockCodelistWithCodes;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockVariable;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockVariableElement;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockVariableElementResult;
import static org.siemac.metamac.srm.rest.external.v1_0.code.utils.CodesDoMocks.mockVariableFamily;
...
public class CodesDo2RestMapperTest {
    ...
    public void testToCodelists() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/codelists" + "/" + agencyID + "/" + resourceID + "?query=" + query + "&orderBy=" + orderBy;
    ...
    public void testToCodelist() throws MetamacException {
        ...
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/codelists/agencyID1/resourceID1/01.123";
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/codelistfamilies/family1", target.getFamily().getSelfLink().getHref());
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/codelists/agencyID1/codelistReplacedBy/01.000", target.getReplacedBy().getSelfLink().getHref());
    ...
    public void testToCodes() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/codelists" + "/" + agencyID + "/" + codeSchemeID + "/" + version + "/codes?query=" + query + "&orderBy=" + orderBy;
        assertEquals(baseLink + "&limit=" + limit + "&offset=" + offset, target.getSelfLink());
        assertEquals(baseLink + "&limit=" + limit + "&offset=0", target.getFirstLink());
        assertEquals(baseLink + "&limit=" + limit + "&offset=0", target.getPreviousLink());
        assertEquals(baseLink + "&limit=" + limit + "&offset=8", target.getNextLink());
    ...
    public void testToCodesItemResult() {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/codelists" + "/" + agencyID + "/" + codelistID + "/" + version + "/codes", target.getSelfLink());
    ...
    public void testToCode() {
        ...
        String parentLink = "http://data.istac.es/apis/structural-resources/v1.0/codelists/agencyID1/resourceID1/01.123/codes";
    ...
    public void testToVariableFamilies() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/variablefamilies?query=" + query + "&orderBy=" + orderBy;
    ...
    public void testToVariableFamily() throws MetamacException {
        ...
        assertEquals(null, target.getUrnProvider());
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/variablefamilies/variableFamily1";
    ...
    public void testToVariables() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/variables?query=" + query + "&orderBy=" + orderBy;
    ...
    public void testToVariable() throws MetamacException {
        ...
        assertEquals(null, target.getUrnProvider());
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/variables/variable1";
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/variables/variableReplacedBy1", target.getReplacedBy().getSelfLink().getHref());
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/variables/variableReplaceTo1", target.getReplaceTo().getReplaceTos().get(0).getSelfLink().getHref());
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/variablefamilies/variableFamily1", target.getFamily().getFamilies().get(0).getSelfLink().getHref());
    ...
    public void testToVariableElement() throws MetamacException {
        ...
        assertEquals(null, target.getUrnProvider());
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/variables/variable01/variableelements/variableElement1";
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/variables/variable01", target.getVariable().getSelfLink().getHref());

        assertEquals(SrmRestConstants.KIND_VARIABLE_ELEMENTS, target.getParentLink().getKind());
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/variables/variable01/variableelements", target.getParentLink().getHref());
    ...
    public void testToCodelistFamilies() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/codelistfamilies?query=" + query + "&orderBy=" + orderBy;
    ...
    public void testToCodelistFamily() throws MetamacException {
        ...
        assertEquals(null, target.getUrnProvider());
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/codelistfamilies/codelistFamily1";
