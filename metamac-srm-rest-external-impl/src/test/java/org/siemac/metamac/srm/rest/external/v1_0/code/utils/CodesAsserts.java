...
public class CodesAsserts {
    ...
    public static void assertEqualsResource(CodelistVersionMetamac expected, Resource actual) {
        ...
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/codelists/" + agency + "/" + code + "/" + version;
    ...
    public static void assertEqualsResource(ItemSchemeVersion itemSchemeVersion, CodeMetamac expected, ItemResult expectedItemResult, Resource actual) {
        ...
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/codelists/" + agency + "/" + codeItemScheme + "/" + version + "/codes/" + code;
        ...
        if (expected != null) {
            ...
            Asserts.assertEqualsResource(expectedItemResult, SrmRestConstants.KIND_CODE, expectedSelfLink, expectedManagementLink, actual, itemSchemeVersion.getMaintainableArtefact().getIsImported());
        }
    }
    ...
    public static void assertEqualsResource(VariableFamily expected, Resource actual) {
        ...
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/variablefamilies/" + code;
    ...
    public static void assertEqualsResource(Variable expected, Resource actual) {
        String code = expected.getNameableArtefact().getCode();
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/variables/" + code;
    ...
    public static void assertEqualsResource(VariableElement expected, Resource actual) {
        String code = expected.getIdentifiableArtefact().getCode();
        String variableID = expected.getVariable().getNameableArtefact().getCode();
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/variables/" + variableID + "/variableelements/" + code;
    ...
    public static void assertEqualsResource(CodelistFamily expected, Resource actual) {
        String code = expected.getNameableArtefact().getCode();
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/codelistfamilies/" + code;
