package org.siemac.metamac.srm.rest.external.v1_0.concept.mapper;
...
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsAsserts.assertEqualsRelatedConcepts;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsAsserts.assertEqualsResource;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsAsserts.assertEqualsRoleConcepts;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsDoMocks.mockConcept;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsDoMocks.mockConceptItemResult;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsDoMocks.mockConceptScheme;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsDoMocks.mockConceptSchemeWithConcepts;
import static org.siemac.metamac.srm.rest.external.v1_0.concept.utils.ConceptsDoMocks.mockConceptWithConceptRelations;
...
public class ConceptsDo2RestMapperTest {
    ...
    public void testToConceptSchemes() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/conceptschemes" + "/" + agencyID + "/" + resourceID + "?query=" + query + "&orderBy=" + orderBy;
    ...
    public void testToConcepts() {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/conceptschemes" + "/" + agencyID + "/" + conceptSchemeID + "/" + version + "/concepts?query=" + query + "&orderBy="
                + orderBy;
        assertEquals(baseLink + "&limit=" + limit + "&offset=" + offset, target.getSelfLink());
        assertEquals(baseLink + "&limit=" + limit + "&offset=0", target.getFirstLink());
        assertEquals(baseLink + "&limit=" + limit + "&offset=0", target.getPreviousLink());
    ...
    public void testToConceptsItemResult() {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/conceptschemes" + "/" + agencyID + "/" + conceptSchemeID + "/" + version + "/concepts", target.getSelfLink());
    ...
    public void testToConcept() {
        ...
        String parentLink = "http://data.istac.es/apis/structural-resources/v1.0/conceptschemes/agencyID1/resourceID1/01.123/concepts";
