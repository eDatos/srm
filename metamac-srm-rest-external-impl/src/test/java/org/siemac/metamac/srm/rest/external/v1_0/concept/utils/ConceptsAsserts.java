package org.siemac.metamac.srm.rest.external.v1_0.concept.utils;
...
public class ConceptsAsserts extends Asserts {
    ...
    public static void assertEqualsResource(ConceptSchemeVersionMetamac expected, Resource actual) {
        ...
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/conceptschemes/" + agency + "/" + code + "/" + version;
    ...
    public static void assertEqualsResource(ItemSchemeVersion itemSchemeVersion, ConceptMetamac expected, ItemResult expectedItemResult, Resource actual) {
        ...
        String expectedSelfLink = "http://data.istac.es/apis/structural-resources/v1.0/conceptschemes/" + agency + "/" + codeItemScheme + "/" + version + "/concepts/" + code;
