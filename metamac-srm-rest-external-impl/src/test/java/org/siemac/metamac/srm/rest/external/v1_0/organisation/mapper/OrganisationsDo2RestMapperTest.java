package org.siemac.metamac.srm.rest.external.v1_0.organisation.mapper;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNull;
import static org.siemac.metamac.common.test.utils.MetamacAsserts.assertEqualsDate;
import static org.siemac.metamac.rest.api.constants.RestApiConstants.WILDCARD_ALL;
import static org.siemac.metamac.srm.rest.external.v1_0.organisation.utils.OrganisationsAsserts.assertEqualsResource;
import static org.siemac.metamac.srm.rest.external.v1_0.organisation.utils.OrganisationsDoMocks.mockOrganisation;
...
public class OrganisationsDo2RestMapperTest {
    ...
    public void testToAgencySchemes() throws MetamacException {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/" + SrmRestConstants.LINK_SUBPATH_AGENCY_SCHEMES + "/" + agencyID + "/" + resourceID + "?query=" + query + "&orderBy="
                + orderBy;
    ...
    public void testToOrganisationUnitSchemes() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/organisationunitschemes?limit=1&offset=0", target.getSelfLink());
    ...
    public void testToDataConsumerSchemes() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/dataconsumerschemes?limit=1&offset=0", target.getSelfLink());
    ...
    public void testToDataProviderSchemes() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/dataproviderschemes?limit=1&offset=0", target.getSelfLink());
    ...
    public void testToAgencyScheme() throws MetamacException {
        ...
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/agencyschemes/agencyID1/AGENCIES/01.000";
    ...
    public void testToDataConsumerScheme() throws MetamacException {
        ...
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/dataconsumerschemes/agencyID1/DATACONSUMERS/01.000";
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/dataconsumerschemes", target.getParentLink().getHref());
        assertEquals(BigInteger.ONE, target.getChildLinks().getTotal());
    ...
    public void testToDataProviderScheme() throws MetamacException {
        ...
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/dataproviderschemes/agencyID1/DATAPROVIDERS/01.000";
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/dataproviderschemes", target.getParentLink().getHref());
    ...
    public void testToOrganisationUnitScheme() throws MetamacException {
        ...
        String selfLink = "http://data.istac.es/apis/structural-resources/v1.0/organisationunitschemes/agencyID1/resourceID1/01.000";
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/organisationunitschemes", target.getParentLink().getHref());
    ...
    public void testToAgencies() throws MetamacException {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources/v1.0/agencyschemes" + "/" + agencyID + "/" + organisationSchemeID + "/" + version + "/agencies?query=" + query + "&orderBy="
                + orderBy;
        ...
        for (int i = 0; i < sources.size(); i++) {
            ...
            Resource target = targets.getAgencies().get(i);
    ...
    public void testToAgenciesItemResult() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/agencyschemes" + "/" + agencyID + "/" + organisationSchemeID + "/" + version + "/agencies", targets.getSelfLink());
    ...
    public void testToDataConsumers() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/dataconsumerschemes/~all/~all/~all/dataconsumers?limit=4&offset=0", targets.getSelfLink());

        assertEquals(sources.size(), targets.getDataConsumers().size());
        for (int i = 0; i < sources.size(); i++) {
            OrganisationMetamac source = sourcesPagedResult.getValues().get(i);
            Resource target = targets.getDataConsumers().get(i);
    ...
    public void testToDataProviders() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/dataproviderschemes/~all/~all/~all/dataproviders?limit=4&offset=0", targets.getSelfLink());

        assertEquals(sources.size(), targets.getDataProviders().size());
        for (int i = 0; i < sources.size(); i++) {
            OrganisationMetamac source = sourcesPagedResult.getValues().get(i);
            Resource target = targets.getDataProviders().get(i);
    ...
    public void testToOrganisationUnits() throws MetamacException {
        ...
        assertEquals("http://data.istac.es/apis/structural-resources/v1.0/organisationunitschemes/~all/~all/~all/organisationunits?limit=4&offset=0", targets.getSelfLink());

        assertEquals(sources.size(), targets.getOrganisationUnits().size());
        for (int i = 0; i < sources.size(); i++) {
            OrganisationMetamac source = sourcesPagedResult.getValues().get(i);
            Resource target = targets.getOrganisationUnits().get(i);
    ...
    public void testToAgency() throws MetamacException {
        ...
        String parentLink = "http://data.istac.es/apis/structural-resources/v1.0/agencyschemes/agencyID1/AGENCIES/01.000/agencies";
    ...
    public void testToDataConsumer() throws MetamacException {
        ...
        String parentLink = "http://data.istac.es/apis/structural-resources/v1.0/dataconsumerschemes/agencyID1/DATACONSUMERS/01.000/dataconsumers";
        String selfLink = parentLink + "/organisation2";
    ...
    public void testToDataProvider() throws MetamacException {
        ...
        String parentLink = "http://data.istac.es/apis/structural-resources/v1.0/dataproviderschemes/agencyID1/DATAPROVIDERS/01.000/dataproviders";
        String selfLink = parentLink + "/organisation2";
    ...
    public void testToOrganisationUnit() throws MetamacException {
        ...
        String parentLink = "http://data.istac.es/apis/structural-resources/v1.0/organisationunitschemes/agencyID1/resourceID1/01.000/organisationunits";
        String selfLink = parentLink + "/organisation2";
