...
public class ContentConstraintsDo2RestMapperV10Impl extends BaseDo2RestMapperV10Impl implements ContentConstraintsDo2RestMapperV10 {
     ...
     * @return
     */
    private String toContenConstraintManagementApplicationLink(ContentConstraint source) {
        return getInternalWebApplicationNavigation().buildContentConstraintUrl(source);
    }

    private ResourceInternal toResource(ContentConstraint source) {
        if (source == null) {
            return null;
        }
        ResourceInternal target = new ResourceInternal();
        toResource(source.getMaintainableArtefact(), SrmRestConstants.KIND_CONTENT_CONSTRAINT, toContentConstraintSelfLink(source), toContenConstraintManagementApplicationLink(source), target);
        return target;
    }
    ...
    private org.siemac.metamac.rest.structural_resources_internal.v1_0.domain.KeyPart toKeyPart(KeyPart source) {
        if (source == null) {
            return null;
        }
