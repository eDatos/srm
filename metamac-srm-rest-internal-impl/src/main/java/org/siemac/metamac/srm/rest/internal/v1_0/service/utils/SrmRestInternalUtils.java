...
public class SrmRestInternalUtils {
    ...
    public static List<ConditionalCriteria> buildConditionalCriteriaContentConstraints(String agencyID, String resourceID, String version, String includeDraft,
            List<ConditionalCriteria> conditionalCriteriaQuery, Class entity) {
    ...
    private static List<ConditionalCriteria> buildConditionalCriteriaMaintainableArtefacts(String agencyID, String resourceID, String version, String includeDraft,
            List<ConditionalCriteria> conditionalCriteriaQuery, Class entity, MaintainableArtefactProperty maintainableArtefactProperty) {
    ...
    public static Set<String> parseFieldsParameter(String fieldsParam) {
        ...
        if (fieldsParam != null) {
            ...
            validFields.add(SrmRestConstants.FIELD_DESCRIPTION);
