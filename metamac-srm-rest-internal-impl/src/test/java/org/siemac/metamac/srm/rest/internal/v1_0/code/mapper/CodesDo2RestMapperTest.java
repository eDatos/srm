...
public class CodesDo2RestMapperTest {
    ...
    public void testToCodelist() throws MetamacException {
        ...
        assertEquals("urn:sdmx:org.sdmx.infomodel.codelist.Codelist=agencyID1:resourceID1(01.123)", target.getUrnProvider());
        ...
        assertEquals("urn:siemac:org.siemac.metamac.infomodel.structuralresources.CodelistFamily=family1", target.getFamily().getUrnProvider());
        ...
        assertEquals("urn:siemac:org.siemac.metamac.infomodel.structuralresources.Variable=variable1", target.getVariable().getUrnProvider());
        ...
        assertEquals("urn:sdmx:org.sdmx.infomodel.codelist.Codelist=agencyID1:codelistReplacedBy(01.000)", target.getReplacedBy().getUrnProvider());
    ...
    public void testToCodelistReplacedBy() throws MetamacException {
        ...
        }
        {
            ...
            assertEquals("urn:sdmx:org.sdmx.infomodel.codelist.Codelist=agencyID2:codelistReplacedBy(01.000)", target.getReplacedBy().getUrnProvider());
        }
    }
    ...
    public void testToVariableFamily() throws MetamacException {
        ...
        assertEquals("urn:siemac:org.siemac.metamac.infomodel.structuralresources.VariableFamily=variableFamily1", target.getUrnProvider());
    ...
    public void testToVariable() throws MetamacException {
        ...
        assertEquals("urn:siemac:org.siemac.metamac.infomodel.structuralresources.Variable=variable1", target.getUrnProvider());
    ...
    public void testToCodelistFamily() throws MetamacException {
        ...
        assertEquals("urn:siemac:org.siemac.metamac.infomodel.structuralresources.CodelistFamily=codelistFamily1", target.getUrnProvider());
