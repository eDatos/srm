...
public class CodesAsserts {
    ...
    public static void assertEqualsResource(ItemSchemeVersion itemSchemeVersion, CodeMetamac expected, ItemResult expectedItemResult, ResourceInternal actual) {
        ...
        if (expected != null) {
            ...
            Asserts.assertEqualsResource(expectedItemResult, RestInternalConstants.KIND_CODE, expectedSelfLink, expectedManagementLink, actual, itemSchemeVersion.getMaintainableArtefact()
                    .getIsImported());
        }
    }
    ...
    public static void assertEqualsResource(VariableFamily expected, ResourceInternal actual) {
        ...
        Asserts.assertEqualsResource(expected.getNameableArtefact(), RestInternalConstants.KIND_VARIABLE_FAMILY, expectedSelfLink, expectedManagementLink, actual, false);
    }
    ...
    public static void assertEqualsResource(CodelistFamily expected, ResourceInternal actual) {
        ...
        Asserts.assertEqualsResource(expected.getNameableArtefact(), RestInternalConstants.KIND_CODELIST_FAMILY, expectedSelfLink, expectedManagementLink, actual, false);
    }
}