...
public class ConceptsDoMocks extends DoMocks {
    ...
    public static ConceptMetamac mockConceptWithConceptRelations(String resourceID, ItemSchemeVersion itemSchemeVersion, ConceptMetamac parent) {
        ...
        // relations
        concept.setConceptExtends(mockConcept("1_conceptExtends1", mockConceptScheme("agencyID1", "resourceID11", "01.000"), null));
        concept.addRoleConcept(mockConcept("1_conceptRole1", mockConceptScheme("agencyID1", "resourceID22", "02.000"), null));
        concept.addRoleConcept(mockConcept("1_conceptRole2", mockConceptScheme("agencyID1", "resourceID33", "03.000"), null));
        concept.addRelatedConcept(mockConcept("1_conceptRelated1", itemSchemeVersion, null));
        concept.addRelatedConcept(mockConcept("1_conceptRelated2", itemSchemeVersion, null));
        concept.addRelatedConcept(mockConcept("1_conceptRelated3", itemSchemeVersion, null));
