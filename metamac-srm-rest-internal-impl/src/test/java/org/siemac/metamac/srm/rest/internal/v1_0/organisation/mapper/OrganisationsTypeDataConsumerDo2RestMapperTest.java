...
public class OrganisationsTypeDataConsumerDo2RestMapperTest {
    ...
    public void testToDataConsumerSchemes() throws MetamacException {
        ...
        String baseLink = "http://data.istac.es/apis/structural-resources-internal/v1.0/" + RestInternalConstants.LINK_SUBPATH_DATA_CONSUMER_SCHEMES + "/" + agencyID + "/" + resourceID + "?query="
    ...
    public void testToDataConsumerScheme() throws MetamacException {
        ...
        assertEquals("urn:sdmx:org.sdmx.infomodel.base.DataConsumerScheme=agencyID1:DATACONSUMERS(01.000)", target.getUrnProvider());
        ...
        // do not retrieve dataconsumers
        assertEquals(0, target.getDataConsumers().size());
    }

    @Test
    public void testToDataConsumerSchemeImported() throws MetamacException {

        OrganisationSchemeVersionMetamac source = mockOrganisationScheme("agencyID1", "DATACONSUMERS", "01.000", OrganisationSchemeTypeEnum.DATA_CONSUMER_SCHEME);
    ...
    public void testToDataConsumers() throws MetamacException {
        ...
        // Transform
        DataConsumers targets = do2RestInternalMapper.toDataConsumers(sourcesPagedResult, agencyID, organisationSchemeID, version, query, orderBy, limit);

        // Validate
        assertEquals(RestInternalConstants.KIND_DATA_CONSUMERS, targets.getKind());

        String baseLink = "http://data.istac.es/apis/structural-resources-internal/v1.0/dataconsumerschemes" + "/" + agencyID + "/" + organisationSchemeID + "/" + version + "/dataconsumers?query="
                + query + "&orderBy=" + orderBy;
    ...
    public void testToDataConsumer() throws MetamacException {
        ...
        assertEquals("urn:sdmx:org.sdmx.infomodel.base.DataConsumer=agencyID1:DATACONSUMERS(01.000).organisation2", target.getUrnProvider());
