...
import org.siemac.metamac.srm.rest.internal.v1_0.utils.StatisticalOperationsRestMocks;
...
public class SrmRestInternalFacadeV10ConceptsTest extends SrmRestInternalFacadeV10BaseTest {
    ...
    private void mockRetrieveStatisticalOperationById() throws MetamacException {
        when(statisticalOperationsRestInternalFacade.retrieveOperation(any(String.class))).thenAnswer(new Answer<Operation>() {
