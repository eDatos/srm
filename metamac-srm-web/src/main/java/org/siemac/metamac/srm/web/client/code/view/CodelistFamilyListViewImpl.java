...
import org.siemac.metamac.srm.web.client.code.widgets.NewCodelistFamilyWindow;
...
public class CodelistFamilyListViewImpl extends ViewWithUiHandlers<CodelistFamilyListUiHandlers> implements CodelistFamilyListPresenter.CodelistFamilyListView {
    ...
    private void setCodelistFamilies(List<CodelistFamilyDto> codelistFamilyDtos) {
        ...
        for (CodelistFamilyDto scheme : codelistFamilyDtos) {
            records[index++] = org.siemac.metamac.srm.web.client.code.utils.RecordUtils.getCodelistFamilyRecord(scheme);
        }
