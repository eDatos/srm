...
import org.siemac.metamac.srm.web.client.code.widgets.NewVariableFamilyWindow;
...
public class VariableFamilyListViewImpl extends ViewWithUiHandlers<VariableFamilyListUiHandlers> implements VariableFamilyListPresenter.VariableFamilyListView {
    ...
    private void setVariableFamilies(List<VariableFamilyDto> variableFamilyDtos) {
        ...
        for (VariableFamilyDto scheme : variableFamilyDtos) {
            records[index++] = org.siemac.metamac.srm.web.client.code.utils.RecordUtils.getVariableFamilyRecord(scheme);
        }
