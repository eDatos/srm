...
import org.siemac.metamac.srm.web.client.code.model.ds.VariableElementOperationDS;
import org.siemac.metamac.srm.web.client.code.utils.RecordUtils;
import org.siemac.metamac.srm.web.client.code.view.handlers.BaseVariableUiHandlers;
    ...
    public VariableElementOperationLayout(String title) {
        ...
        deleteConfirmationWindow.getYesButton().addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                uiHandlers.deleteVariableElementOperations(org.siemac.metamac.srm.web.client.code.utils.CommonUtils.getCodesFromSelectedVariableElementOperations(variableElementOperationsListGrid
                        .getSelectedRecords()));
