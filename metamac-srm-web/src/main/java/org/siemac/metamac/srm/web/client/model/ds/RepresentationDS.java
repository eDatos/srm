...
public class RepresentationDS extends DataSource {
    ...
    public static final String ENUMERATED_CODELIST              = "repr-enum-cl";
    public static final String ENUMERATED_CODELIST_EDITION_VIEW = "repr-enum-cl-ed-view"; // Not mapped in DTO
    public static final String ENUMERATED_CODELIST_VIEW         = "repr-enum-cl-view";   // Not mapped in DTO
