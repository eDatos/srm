...
public class RelatedResourceItemSchemeFilterForm extends SimpleFilterBaseForm<RelatedResourceWebCriteria> {

    protected OnlyLastVersionFacetFilter onlyLastVersionFacet;

    public RelatedResourceItemSchemeFilterForm() {
        super();
    ...
    // IMPORTANT: This method must be inherited if you change/extend the WebCriteria in T
    @Override
