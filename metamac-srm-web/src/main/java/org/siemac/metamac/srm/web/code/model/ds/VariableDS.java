...
public class VariableDS extends DataSource {
    ...
    public static final String CREATION_DATE        = "var-creation-date";
    public static final String CREATION_USER        = "var-creation-user";
    public static final String LAST_UPDATE_DATE     = "var-last-update-date";
    public static final String LAST_UPDATE_USER     = "var-last-update-user";
