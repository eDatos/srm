...
public class NewCodelistWindow extends CustomWindow {
    ...
    private static final String                FORM_ITEM_CUSTOM_WIDTH = "300";
    ...
    public void setVariables(GetVariablesResult result) {
        List<RelatedResourceDto> variables = RelatedResourceUtils.getVariableBasicDtosAsRelatedResourceDtos(result.getVariables());
