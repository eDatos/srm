...
public class ConceptSchemeViewImpl extends ViewWithUiHandlers<ConceptSchemeUiHandlers> implements ConceptSchemePresenter.ConceptSchemeView {
    ...
    private void bindMainFormLayoutEvents() {
        ...
        mainFormLayout.getLifeCycleReSendStreamMessage().addClickHandler(new ClickHandler() {
            ...
            @Override
            public void onClick(ClickEvent event) {
                getUiHandlers().reSendStreamMessageConceptScheme(conceptSchemeDto.getUrn());
            }
        });
    }
    ...
    private void createViewForm() {
        ...
        ViewTextItem publicationStreamStatus = new ViewTextItem(ConceptSchemeDS.PUBLICATION_STREAM_STATUS, getConstants().lifeCycleStructuralResourceStreamMsgStatus());
        publicationStreamStatus.setWidth(20);

        identifiersForm.setFields(code, name, uri, urn, urnProvider, version, publicationStreamStatus);
        ...
        ViewTextItem creationUser = new ViewTextItem(ConceptSchemeDS.VERSION_CREATION_USER, getConstants().maintainableArtefactVersionCreationUser());
        ViewTextItem lastUpdateDate = new ViewTextItem(ConceptSchemeDS.VERSION_LAST_UPDATE_DATE, getConstants().maintainableArtefactVersionLastUpdateDate());
        ViewTextItem lastUpdateUser = new ViewTextItem(ConceptSchemeDS.VERSION_LAST_UPDATE_USER, getConstants().maintainableArtefactVersionLastUpdateUser());
    ...
    public void setConceptSchemeViewMode(ConceptSchemeMetamacDto conceptSchemeDto) {
        ...
        identifiersForm.setValue(ConceptSchemeDS.NAME, conceptSchemeDto.getName());
        identifiersForm.getItem(ConceptSchemeDS.PUBLICATION_STREAM_STATUS)
                .setIcons(StreamMessageStatusEnum.PENDING.equals(conceptSchemeDto.getStreamMessageStatus()) ? null : CommonSharedUtils.getPublicationStreamStatusIcon(conceptSchemeDto.getStreamMessageStatus()));
        ...
        productionDescriptorsForm.setValue(ConceptSchemeDS.VERSION_CREATION_DATE, conceptSchemeDto.getCreatedDate());
        productionDescriptorsForm.setValue(ConceptSchemeDS.VERSION_CREATION_USER, conceptSchemeDto.getCreatedBy());
        productionDescriptorsForm.setValue(ConceptSchemeDS.VERSION_LAST_UPDATE_DATE, conceptSchemeDto.getLastUpdated());
        productionDescriptorsForm.setValue(ConceptSchemeDS.VERSION_LAST_UPDATE_USER, conceptSchemeDto.getLastUpdatedBy());
        productionDescriptorsForm.setValue(ConceptSchemeDS.RESOURCE_CREATION_DATE, conceptSchemeDto.getResourceCreatedDate());
        ...
        // Comments
        commentsForm.setValue(ConceptSchemeDS.COMMENTS, conceptSchemeDto.getComment());
    ...
    public void setConceptSchemeEditionMode(ConceptSchemeMetamacDto conceptSchemeDto) {
        ...
        identifiersEditionForm.setValue(ConceptSchemeDS.NAME, conceptSchemeDto.getName());
        ...
        productionDescriptorsEditionForm.setValue(CodelistDS.VERSION_CREATION_USER, conceptSchemeDto.getCreatedBy());
        productionDescriptorsEditionForm.setValue(CodelistDS.VERSION_LAST_UPDATE_DATE, conceptSchemeDto.getLastUpdated());
        productionDescriptorsEditionForm.setValue(CodelistDS.VERSION_LAST_UPDATE_USER, conceptSchemeDto.getLastUpdatedBy());
        ...
        commentsEditionForm.setValue(ConceptSchemeDS.COMMENTS, conceptSchemeDto.getComment());
    ...
    public ConceptSchemeMetamacDto getConceptSchemeDto() {
        ...
        conceptSchemeDto.setName(identifiersEditionForm.getValueAsInternationalStringDto(ConceptSchemeDS.NAME));
        // Content descriptors
        conceptSchemeDto.setDescription(contentDescriptorsEditionForm.getValueAsInternationalStringDto(ConceptSchemeDS.DESCRIPTION));
        // Class descriptors
        ...
        // Comments
        conceptSchemeDto.setComment(commentsEditionForm.getValueAsInternationalStringDto(ConceptSchemeDS.COMMENTS));
