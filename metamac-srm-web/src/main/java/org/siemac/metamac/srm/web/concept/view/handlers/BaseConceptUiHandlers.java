...
public interface BaseConceptUiHandlers extends CategorisationUiHandlers {
    ...
    void updateConceptParent(String conceptUrn, String newParentUrn, int newConceptIndex);
    void updateConceptInOrder(String conceptUrn, String urn, int newConceptIndex);
}
