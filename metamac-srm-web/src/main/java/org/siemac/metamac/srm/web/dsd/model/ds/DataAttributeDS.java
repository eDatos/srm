...
public class DataAttributeDS {
    ...
    public static final String CODE_VIEW                                       = "attr-code-view";             // Not mapped in DTO
    ...
    public static final String RELATED_TO                                      = "attr-related-to";
    ...
    public static final String ENUMERATED_REPRESENTATION_CODELIST              = "attr-repr-enum-code";
    public static final String ENUMERATED_REPRESENTATION_CODELIST_EDITION_VIEW = "attr-repr-enum-code-ed-view"; // Not mapped in DTO
    public static final String ENUMERATED_REPRESENTATION_CODELIST_VIEW         = "attr-repr-enum-code-view";   // Not mapped in DTO
}
