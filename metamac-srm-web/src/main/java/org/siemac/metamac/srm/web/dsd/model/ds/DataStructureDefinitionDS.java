...
public class DataStructureDefinitionDS extends VersionableResourceDS {
    ...
    public static final String DIMENSION_CODES_DISPLAY_ORDER         = "dsd-display-order";
    public static final String DIMENSION_CODES_HIERARCHY_LEVELS_OPEN = "dsd-levels-open";
