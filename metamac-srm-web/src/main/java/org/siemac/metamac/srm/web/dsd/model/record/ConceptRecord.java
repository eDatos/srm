...
public class ConceptRecord extends ListGridRecord {
    ...
    public ConceptRecord(String id, String scheme, String codeId, ExternalItemBtDto concept) {
        setIdentifier(id);
        setScheme(scheme);
        setCodeId(codeId);
        setConcept(concept);
    ...
    public void setConcept(ExternalItemBtDto value) {
    ...
    public ExternalItemBtDto getConcept() {
        return (ExternalItemBtDto) getAttributeAsObject(CONCEPT);
    }
