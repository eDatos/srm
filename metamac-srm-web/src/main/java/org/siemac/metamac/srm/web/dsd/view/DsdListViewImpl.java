...
public class DsdListViewImpl extends ViewWithUiHandlers<DsdListUiHandlers> implements DsdListPresenter.DsdListView {
    ...
    public DataStructureDefinitionMetamacDto getNewDsd() {
        ...
        RelatedResourceDto agency = new RelatedResourceDto("agency_CODE", "urn:sdmx:org.sdmx.infomodel.base.AgencyScheme=SDMX:SDMX_AGENCY_SCHEME(01.000).SDMX_AGENCY", TypeExternalArtefactsEnum.AGENCY);
