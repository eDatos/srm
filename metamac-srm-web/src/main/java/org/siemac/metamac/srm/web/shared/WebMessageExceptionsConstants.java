...
public class WebMessageExceptionsConstants {
    ...
    public static final String MAINTAINABLE_ARTEFACT_ERROR_RELATED_OPERATION_NOT_EXTERNALLY_PUBLISHED = "exception.srm.maintainable_artefact.related_operation_not_externally_published";
